...
(async function() {
  ...
  const activities = await Activity.create([
    ...
    {name: 'Brooklyn', description: 'Visit where Biggie grew up and see the famous Brooklyn Bridge', category: categories[0], duration: 150},
    ...
    {name: 'Agile & Scrum', description: 'learn how to help software teams be more productive and dynamic', category: categories[1], duration: 60},
    ...
    {name: 'Aerobics', description: 'bring your leotard and we will sweat like Jane Fonda', category: categories[2], duration: 75},
    ...
    {name: 'Snorkling in the East River', description: 'what else is there to say?', category: categories[3], duration: 120},
    ...
    {name: 'Terminator chat', description: 'if you want to blow your mind I will try to explain the Terminator timeline regarding John Connor and his father', category: categories[4], duration: 240},
    ...
    {name: 'There is a Mountain vs Mountain Jam', description: 'compare the Donovan classic to the Allman Bros extended 1969 jam', category: categories[5], duration: 60},
  ]);
